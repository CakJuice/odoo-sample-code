...
class KaHrHolidaysCleanField(models.TransientModel):
	...
	def do_clean_field(self):
		...
		self._drop_table_constraint('hr_employee_status', 'hr_employee_status_unique')
		self._drop_table_constraint('hr_employee', 'hr_employee_status_id_fkey')
		self._drop_table_constraint('hr_config', 'hr_config_hr_status_staf_id_fkey')
		self._drop_model('hr.employee.status')
		self._drop_model('hr.employee.history')
		self._remove_field('ka_hr_employee_keluarga', 'hub_keluarga_id')
		self._drop_model('ka_hr.hubungan.keluarga')
		self._remove_field('hr_employee_graduate', 'graduate_id')
		self._drop_model('hr.graduate')
